...
<%@ page import="java.sql.*, com.gdut.bbs.*, java.util.*"%>
			...
			<tbody>
				<tr valign="top">
					<td><span class="nobreak"> 页: 第<%=pageNo%>页，共<%=totalPages%>页
							- <span class="jive-paginator"> [ </span></span> <span class="nobreak"><span
							class="jive-paginator"> <a href="articleFlat.jsp?pageNo=1">第一页</a></span></span>
					...
					<td width="99%"><div class="jive-thread-list">
									...
									<tbody>
										...
										<tr class=<%=classStr%>>
											...
											<td class="jive-author" nowrap="nowrap" width="1%"><span
												class=""> <a
													href="http://bbs.chinajavaworld.com/profile.jspa?userID=226030">gdut</a>
											</span></td>
						...
						.format(a.getPdate())%>
													<br> by: <a
														...
														title="jingjiangjun" style="">gdut &#187;</a>
												</div></td>
										</tr>
